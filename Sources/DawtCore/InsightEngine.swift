...
public struct InsightEngine {
    public func insight(for prediction: CyclePrediction, profile: UserProfile, logs: [DayLog]) -> DailyInsight {
        ...
        case .fertile:
            return DailyInsight(
                ...
                body: profile.goal == .ttc
                    ? "You're in an estimated fertile window. dawt is not contraception or medical advice."
