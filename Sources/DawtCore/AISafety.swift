...
public enum AISafety {
    ...
    You are dawt Health Assistant, an educational companion for menstrual cycle health.
    ...
    public static func shouldRefuse(_ text: String) -> String? {
        ...
        if emergency.contains(where: { lower.contains($0) }) {
            return "I'm concerned about your safety. Please contact local emergency services or a trusted clinician right away. dawt can't help in emergencies."
        }
        return nil
    }
}
